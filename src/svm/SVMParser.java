...
public class SVMParser extends Parser {
	...
	public static final int
		...
		OR=26, NOT=27, HALT=28, REGISTER=29, COL=30, LABEL=31, NUMBER=32, BOOL=33, 
		WHITESP=34, ERR=35;
	public static final String[] tokenNames = {
		"<INVALID>", "'('", "')'", "'push'", "'pop'", "'add'", "'sub'", "'mult'", 
		"'div'", "'addi'", "'subi'", "'multi'", "'divi'", "'li'", "'lb'", "'sw'", 
		"'lw'", "'b'", "'beq'", "'bleq'", "'jr'", "'jal'", "'print'", "'del'", 
		"'mv'", "'and'", "'or'", "'not'", "'halt'", "REGISTER", "':'", "LABEL", 
		"NUMBER", "BOOL", "WHITESP", "ERR"
	};
	public static final int
	...
	public final AssemblyContext assembly() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << PUSH) | (1L << POP) | (1L << ADD) | (1L << SUB) | (1L << MULT) | (1L << DIV) | (1L << ADDI) | (1L << SUBI) | (1L << MULTI) | (1L << DIVI) | (1L << LI) | (1L << LB) | (1L << STOREW) | (1L << LOADW) | (1L << BRANCH) | (1L << BRANCHEQ) | (1L << BRANCHLESSEQ) | (1L << JR) | (1L << JAL) | (1L << PRINT) | (1L << DELETION) | (1L << MOVE) | (1L << AND) | (1L << OR) | (1L << NOT) | (1L << HALT) | (1L << LABEL))) != 0)) {
				{
				{
	...
	public final InstructionContext instruction() throws RecognitionException {
		...
		try {
			...
			case PUSH:
				...
				setState(11); ((InstructionContext)_localctx).reg = match(REGISTER);
				}
				break;
			case POP:
				{
			...
			case PRINT:
				...
				setState(84); ((InstructionContext)_localctx).term1 = match(NUMBER);
				}
				break;
			case DELETION:
				{
				setState(85); match(DELETION);
				setState(86); ((InstructionContext)_localctx).reg = match(REGISTER);
				}
				break;
			case AND:
				{
				setState(87); match(AND);
				setState(88); ((InstructionContext)_localctx).res = match(REGISTER);
				setState(89); ((InstructionContext)_localctx).term1 = match(REGISTER);
				setState(90); ((InstructionContext)_localctx).term2 = match(REGISTER);
				}
				break;
			case OR:
				{
				setState(91); match(OR);
				setState(92); ((InstructionContext)_localctx).res = match(REGISTER);
				setState(93); ((InstructionContext)_localctx).term1 = match(REGISTER);
				setState(94); ((InstructionContext)_localctx).term2 = match(REGISTER);
				}
				break;
			case NOT:
				{
				setState(95); match(NOT);
				setState(96); ((InstructionContext)_localctx).res = match(REGISTER);
				setState(97); ((InstructionContext)_localctx).term1 = match(REGISTER);
				}
				break;
			case HALT:
				{
				setState(98); match(HALT);
				}
				break;
			default:
	...
	public static final String _serializedATN =
		...
		"\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3"+
		"\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3"+
		"\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\3\5\